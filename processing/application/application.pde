...
void draw() 
{
  ...
  if (but1 == 1) //çizmeye başla butonu
  {
  ...
  if(but2 == 1 && but1 != 1) //erase all butonu
  {
    background(255,255,255); //arka planı beyaz yapıyor. umarım erase all olarak çalışıyordur emin değilim.
  }
  
  if(but4 == 1) //kare çizme
  {
    noStroke();
    fill(red,green,blue);
